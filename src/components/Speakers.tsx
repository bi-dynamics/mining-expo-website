              ...
              <div className="relative xl:w-1/3 h-[30vh] xl:h-[40vh] flex items-center justify-center shrink-0">
                ...
                >
                  <Image
                    ...
                    className="object-contain group-hover:scale-110 transition-all duration-1000 md:object-cover scale-[1.4] sm:scale-[1.5] md:scale-[1] translate-y-[1rem] sm:translate-y-[3rem] md:translate-y-0  w-full relative h-full shrink-0"
                  />
