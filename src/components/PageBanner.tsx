...
const PageBanner: React.FC<PageBannerProps> = ({ title }) => {
  return (
    <section
      className={` relative bg-[url('../../public/mining-expo-header_resize.webp')] bg-cover bg-center h-[30vh] xl:h-[50vh] w-full flex items-center justify-center tracking-tight`}
    >
      {/* gradient layer */}
